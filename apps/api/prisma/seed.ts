...
const products = [
  {
    ...
    imageUrl: 'https://images.pexels.com/photos/7812134/pexels-photo-7812134.jpeg?auto=compress&cs=tinysrgb&w=1200',
    spiceLevel: 4,
    basePrice: 34900,
  ...
  },
  {
    ...
    imageUrl: 'https://images.pexels.com/photos/17424800/pexels-photo-17424800.jpeg?auto=compress&cs=tinysrgb&w=1200',
    spiceLevel: 3,
    basePrice: 29900,
    weights: [250, 500, 1000],
    stock: [30, 28, 15],
  },
  {
    ...
    imageUrl: 'https://images.pexels.com/photos/5379435/pexels-photo-5379435.jpeg?auto=compress&cs=tinysrgb&w=1200',
    spiceLevel: 2,
    basePrice: 24900,
    weights: [250, 500, 1000],
    stock: [50, 40, 25],
  },
  {
    ...
    imageUrl: 'https://images.pexels.com/photos/8185493/pexels-photo-8185493.jpeg?auto=compress&cs=tinysrgb&w=1200',
    spiceLevel: 5,
    basePrice: 32900,
    weights: [250, 500, 1000],
    stock: [25, 20, 12],
  },
  {
    ...
    imageUrl: 'https://images.pexels.com/photos/34928304/pexels-photo-34928304.jpeg?auto=compress&cs=tinysrgb&w=1200',
    spiceLevel: 3,
    basePrice: 22900,
    weights: [250, 500, 1000],
    stock: [45, 38, 22],
  },
  {
    ...
    imageUrl: 'https://images.pexels.com/photos/29173111/pexels-photo-29173111.jpeg?auto=compress&cs=tinysrgb&w=1200',
    spiceLevel: 4,
    basePrice: 44900,
    weights: [250, 500, 1000],
    stock: [15, 12, 8],
  ...
  },
  {
    ...
    imageUrl: 'https://images.pexels.com/photos/11584813/pexels-photo-11584813.jpeg?auto=compress&cs=tinysrgb&w=1200',
    spiceLevel: 3,
    basePrice: 27900,
    weights: [250, 500, 1000],
    stock: [35, 30, 18],
  ...
  },
  {
    ...
    imageUrl: 'https://images.pexels.com/photos/35696919/pexels-photo-35696919.jpeg?auto=compress&cs=tinysrgb&w=1200',
    spiceLevel: 4,
    basePrice: 49900,
    weights: [250, 500],
    stock: [12, 10],
  ...
  },
  {
    ...
    imageUrl: 'https://images.pexels.com/photos/34928280/pexels-photo-34928280.jpeg?auto=compress&cs=tinysrgb&w=1200',
    spiceLevel: 2,
    basePrice: 25900,
    weights: [250, 500, 1000],
    stock: [28, 22, 14],
  },
  {
    ...
    imageUrl: 'https://images.pexels.com/photos/4595312/pexels-photo-4595312.jpeg?auto=compress&cs=tinysrgb&w=1200',
    spiceLevel: 3,
    basePrice: 23900,
    weights: [250, 500],
    stock: [32, 26],
  ...
  },
  {
    ...
    imageUrl: 'https://images.pexels.com/photos/12955689/pexels-photo-12955689.jpeg?auto=compress&cs=tinysrgb&w=1200',
    spiceLevel: 5,
    basePrice: 21900,
    weights: [250, 500],
    stock: [38, 30],
